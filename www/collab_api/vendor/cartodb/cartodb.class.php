...
class CartoDBClient {
  ...
  function __construct($config) {
    ...
    $this->TEMP_TOKEN_FILE_PATH = '/Applications/MAMP/htdocs/lmtl/www/collab_api/storage/sessions/cartodbtempkey.txt';
    //$this->TEMP_TOKEN_FILE_PATH = sys_get_temp_dir() . '/cartodbtempkey.txt';

     // print_r($this->TEMP_TOKEN_FILE_PATH);
  ...
  public function createTable($table, $schema = NULL) {
    ...
    $response = $this->request('tables', 'POST', array('params' => $params));
  ...
  public function dropTable($table) {
      $params = array();
    return $this->request("tables/$table", 'DELETE', array('params' => $params));
  }
  ...
  public function dropColumn($table, $column) {
      $params = array();
    return $this->request("tables/$table/columns/$column", 'DELETE', array('params' => $params));
  }
  ...
  public function getRow($table, $row) {
    $params = array();
    return $this->request("tables/$table/records/$row", 'GET', array('params' => $params));
  }
